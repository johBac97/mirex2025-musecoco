...
from .linear_attention_py import CausalLinearAttentionPy
...
class LinearTransformerDecoderLayer(TransformerDecoderLayer):
    ...
    def build_self_attention(
        ...
        # if attn_type == 'CausalLinearAttention':
        #     attn_cls = CausalLinearAttention
        # elif attn_type == 'CausalLinearAttentionPy':
        #     attn_cls = CausalLinearAttentionPy
        # attn_cls = CausalLinearAttention
        attn_cls = CausalLinearAttentionPy

        # causal_linear_attention = CausalLinearAttention(embed_dim)
        causal_linear_attention = attn_cls(embed_dim)
