...
def test_generate():
    ...
    generation = out_str[0].split(' ')
    generation = [x for x in generation if '-' in x]
    tk = RemiTokenizer()
    tk.remi_to_midi(generation, 'test.mid')
...
def test_generate_from_conditions():
    ...
    inp_seq = ['I1s2_0_0', 'I1s2_1_2', 'I1s2_2_2', 'I1s2_3_2', 'I1s2_4_0', 'I1s2_5_0', 'I1s2_6_0', 
                 'I1s2_7_2', 'I1s2_8_2', 'I1s2_9_2', 'I1s2_10_2', 'I1s2_11_2', 'I1s2_12_2', 'I1s2_13_2', 
                 'I1s2_14_2', 'I1s2_15_2', 'I1s2_16_2', 'I1s2_17_2', 'I1s2_18_2', 'I1s2_19_2', 'I1s2_20_2', 
                 'I1s2_21_2', 'I1s2_22_2', 'I1s2_23_2', 'I1s2_24_0', 'I1s2_25_2', 'I1s2_26_2', 'I1s2_27_0', 
                 'I4_28', 'C1_4', 'R1_2', 'R3_3', 'S2s1_17', 'S4_0_2', 'S4_1_2', 'S4_2_2', 'S4_3_2', 
                 'S4_4_2', 'S4_5_2', 'S4_6_2', 'S4_7_2', 'S4_8_2', 'S4_9_2', 'S4_10_2', 'S4_11_2', 
                 'S4_12_2', 'S4_13_2', 'S4_14_2', 'S4_15_2', 'S4_16_2', 'S4_17_2', 'S4_18_2', 'S4_19_2', 
                 'S4_20_2', 'S4_21_2', 'B1s1_3', 'TS1s1_0', 'K1_2', 'T1s1_1', 'P4_12', 'ST1_14', 'EM1_4', 
                 'TM1_2', '<sep>']
    print('len(inp_seq)=', len(inp_seq))
    inp_str = ' '.join(inp_seq)
    print(inp_seq)
    ...
    tk = MuseCocoTokenizer.from_pretrained(tk_fp)
    print('tk:', tk)
    print('xxxx', torch.cuda.is_available())
    model.cuda()

    # Tokenize input
    tokens_hf = tk(inp_str, return_tensors="pt")['input_ids'].cuda() # [1, len]
    print('tokens_hf:', tokens_hf)
    print(tokens_hf.size())
    print('reversed:', tk.batch_decode(tokens_hf))
    inp = torch.cat([tokens_hf[:,-1:], tokens_hf[:,:-1]], dim=1)
    print('inp:', inp)
    ...
    generation = [x for x in generation if '-' in x]
    tk = RemiTokenizer()
    tk.remi_to_midi(generation, 'test1.mid')
